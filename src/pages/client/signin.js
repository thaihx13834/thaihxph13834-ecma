const Signin = {
  render() {
    return /* html */ `
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 my-11 ">
  <div class="max-w-md w-full space-y-8">
    <div>
      <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="Workflow">
      <h2 class="mt-6 text-center text-2xl font-extrabold text-orange-600">
    ...
    <form class="mt-8 space-y-6" action="#" method="POST">
      ...
      <div>
        ...
        <div class="mt-4 text-center">
                  <p class="text-sm">Bạn chưa có tài khoản? <a href="/signup"
                      class="text-blue-600 hover:underline"> Đăng kí.</a></p>
        </div>
      </div>
    </form>
  </div>
