...
const Contact = {
  render() {
    ...
    <div class="max-w-6xl mx-auto ">
          ...
          <div class="max-w-screen-xl mt-24 mb-10 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        <div class="flex flex-col justify-between">
          <div>
            <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Điền thông tin vào form bên cạnh</h2>
            <div class="text-gray-700 mt-8">
              Để góp ý cũng như được hướng dẫn!
            </div>
          </div>
        ...
        <div class="">
          <div>
            <span class="uppercase text-sm text-gray-600 font-bold">Họ và Tên</span>
          ...
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">Địa chỉ email</span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text">
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">Nội dung tin nhắn</span>
