...
const Productdetail = {
    ...
    <div class="pt-6">
      ...
      <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
        ...
        <div class="mt-4 lg:mt-0 lg:row-span-3">
          ...
          <p class="text-3xl text-gray-900">Giá: 200.000 VNĐ</p>
          ...
          <form class="mt-10">
            ...
            <div class="mt-10">
              <div class="flex items-center justify-between">
                <h3 class="text-sm text-gray-900 font-medium">Cỡ</h3>
              </div>
            ...
            <button type="submit" class="mt-10 w-full bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Thêm vào giỏ hàng</button>
          </form>
        </div>
        ...
        <div class="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
          ...
          <div>
            ...
            <div class="space-y-6">
              <p class="text-base text-gray-900">Chất liệu siêu co giãn, mềm mại, thoải mái phù hợp để đi tập, chơi thể thao, chất vải mát</p>
            </div>
          </div>
          ...
          <div class="mt-10">
            ...
            <div class="mt-4">
              <ul role="list" class="pl-4 list-disc text-sm space-y-2">
                <li class="text-gray-400"><span class="text-gray-600">Được sản xuất tại Việt Nam</span></li>
  
                <li class="text-gray-400"><span class="text-gray-600">Có nhiều màu để lựa chọn</span></li>
  
                <li class="text-gray-400"><span class="text-gray-600">Chất vải 100% cottons</span></li>
              </ul>
            </div>
          </div>
  ...
  <div class="max-w-2xl mx-auto py-16 px-4  sm:px-6 lg:max-w-7xl lg:px-8">
            <h2 class="text-2xl font-extrabold tracking-tight text-gray-900">Sản phẩm cùng loại</h2>
