    ...
    return /* html */ `
        ...
        <div class="relative md:ml-80 md:mr-20">
             <div class=" py-10 flex items-center justify-between">
                <h1 class="font-bold text-2xl">Thêm  mới loại hàng</h1>
            ...
            <form action="" id="form-add">
              ...
              >
                ...
                <input
                  ...
                  placeholder="Mời nhập tên loại hàng"
                  name="namelh"
                />
              </div>
