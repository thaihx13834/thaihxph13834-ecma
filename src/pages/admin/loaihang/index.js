...
import { getAll, remove } from "../../../api/categorys";
  ...
  async render() {
    ...
    <div class="relative md:ml-80 md:mr-20">
         <div class=" py-10 flex items-center justify-between">
            <h1 class="font-bold text-2xl">Danh sách loại hàng</h1>
                      ...
                      ${resp.data
                        .map(
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="/admin/loaihang/${item.id}/edit" class="inline-block text-indigo-600 hover:text-indigo-900 p-3">Edit</a>
