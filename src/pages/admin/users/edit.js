    ...
    return /* html */ `
        ...
        <div class="relative  md:ml-80 md:mr-20   ">
             <div class=" py-10 flex items-center justify-between">
                <h1 class="font-bold text-2xl">Sửa khách hàng</h1>
          ...
          <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8 mt-4">
            <form action="" id="form-add">
              ...
              >
                ...
                <input class="user-name shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="${
                  data.fullname
                }">
              </div>
              ...
              >
                ...
                <input class="user-mail shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="email" value="${
                  data.email
                }">
              </div>
              ...
              >
                ...
                <input class="user-pass shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="password" value="${
                  data.password
                }" >
              </div>
              ...
              >
                ...
                <input class="user-address shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  value="${
                  data.address
                }">
              </div>
              ...
              >
                ...
                <input class="user-phonenb shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="${
                  data.phone_number
                }">
              </div>

              <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8 mt-4"><img src="${
                data.img
              }" class="max-w-full"  id="ig"/></div>
